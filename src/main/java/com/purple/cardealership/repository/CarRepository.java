...
public interface CarRepository extends JpaRepository<Car, Long> {
    @Query("SELECT c FROM Car c WHERE (:brand is null or c.brand = :brand) and" +
    ...
    List<Car> findCar(@Param("brand") String brand, @Param("ageStart") Integer ageStart, @Param("ageEnd") Integer ageEnd, @Param("mileageStart") Integer mileageStart,
                      @Param("mileageEnd") Integer mileageEnd, @Param("engineSizeStart") Double engineSizeStart, @Param("engineSizeEnd") Double engineSizeEnd);
}
