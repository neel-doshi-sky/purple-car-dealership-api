...
public class CarController {
    ...
    public CustomResponseEntity create(@RequestBody HashMap<String, String> body) {
        ...
        try {
            ...
            if (Stream.of(brand, model, age, mileage, engineSize).anyMatch(value -> value == null)) {
    ...
    public CustomResponseEntity update(@RequestBody HashMap<String, String> body) {
        try {
            ...
            String brand = body.containsKey("brand") ? body.get("brand") : null;
            String model = body.containsKey("model") ? body.get("model") : null;
